...
const char* SDK::GetWeaponNameByID(int nWeaponID)
{
	switch (nWeaponID)
	{
	...
	case TF_WEAPON_PIPEBOMBLAUNCHER: return "Sticky Launcher";
	case TF_WEAPON_CANNON: return "Loose Cannon";
	case TF_WEAPON_COMPOUND_BOW: return "Huntsman";
	case TF_WEAPON_CROSSBOW: return "Crusader's Crossbow";
	...
	case TF_WEAPON_CLEAVER: return "Flying Guillotine";
	case TF_WEAPON_BAT_WOOD: return "Sandman Ball";
	...
	case TF_WEAPON_FLAMETHROWER: return "Flamethrower";
	case TF_WEAPON_FLAME_BALL: return "Dragon's Fury";
	case TF_WEAPON_STICKY_BALL_LAUNCHER: return "Sticky Jumper";
